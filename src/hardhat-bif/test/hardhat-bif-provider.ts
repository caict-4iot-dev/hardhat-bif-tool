...
describe("HardhatBifProvider", () => {
  ...
  it("getCode should not empty", async () => {
    const code = await provider.getCode(
      "did:bid:ef2ZdaHDrFqcxJCmwjyD8ygsVttanPED",
    );
  ...
  it("getTransaction create contract", async () => {
    const code = await provider.getTransaction(
      "e0b1f5f969e29343626a3399ad29f5ae32349e9dccb08710f500009565193de4",
    );
  ...
  it("getTransaction pay coin", async () => {
    const code = await provider.getTransaction(
      "3f320819309dc3afa44bc15373916229d43dae939a1e4e31b2ab5946a1a4fae8",
    );
    //console.log('getTransaction(hash) : ', JSON.stringify(code));
  });
  ...
  it("getTransaction log", async () => {
    const code = await provider.getTransaction(
      "1eb3833080970d57fa8a25935b220ab2ac466c7b974aa59c81f2b207803d5185",
    );
    //console.log('getTransaction(hash) : ', JSON.stringify(code));
  });

  it("getTransactionReceipt create contract", async () => {
    const code = await provider.getTransactionReceipt(
      "e0b1f5f969e29343626a3399ad29f5ae32349e9dccb08710f500009565193de4",
    );
  ...
  it("getTransactionReceipt paycoin", async () => {
    const code = await provider.getTransactionReceipt(
      "7d150aed022cd8943bff6330523aee7408d8e0df892dc0bf6d739cdebff84279",
    );
    //console.log('getTransactionReceipt(hash) : ', JSON.stringify(code));
  });
