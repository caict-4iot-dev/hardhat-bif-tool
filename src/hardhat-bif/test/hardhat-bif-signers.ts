...
import { HardhatBifProvider } from "../internal/hardhat-bif-provider";
import { HardhatBifSigner } from "../internal/hardhat-bif-signers";
...
class MockEthereumProvider extends LocalBifAccountsProvider {
  constructor(url: string, localBifAccountsPrivateKeys: string[]) {
...
describe("HardhatBifSigner", () => {
  ...
  beforeEach(() => {
    mockHardhatProvider = new MockEthereumProvider(
      ...
      [
        "priSPKnVwNrzJ7KiWxddfUtap7f52B8pnLtoCu6wEW3MmpuKQd",
        "priSPKoJ8vUfXk92axGtokCDiw8cM7KHznL6iugvNxeANctrdL",
        "priSPKpHrcXsX7AY3wSSVZXCfMeX8MvrPEBXeV5hUctomrHiWC",
      ],
    );
  ...
  it("signTransaction createContract equal", async () => {
    ...
    request.nonce = 1;
    request.data =
      "";
    request.type = 1;
