...
export class HardhatBifSigner extends Signer {
  ...
  private constructor(address: string, provider: HardhatBifProvider) {
    super();
  ...
  public connect(provider: HardhatBifProvider): Signer {
  ...
  public async signTransaction(
    ...
    //sign
    let signature = trans.signTransSerialization(
  ...
  public async getPrivateKey(): Promise<string> {
    const privateKeyResult = await this.provider.ethProvider.request({
